...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2020 at 07:42 AM
...
INSERT INTO `tb_checkout` (`id_checkout`, `id_tiket`, `id_tour`, `username`, `jumlah`, `total`, `tanggal`, `status`) VALUES
...
INSERT INTO `tb_kendaraan` (`id_kendaraan`, `nama`, `tipe`, `status`) VALUES
('KD001', 'Toyota Avanza', 'mobil', 1),
('KD002', 'Innova', 'mobil', 1),
('KD003', 'Toyota Hiace', 'mobil', 1),
('KD004', 'Jetbus 2', 'bus', 0),
('KD005', 'Big Bus', 'bus', 1),
('KD006', 'Jetbus 3', 'bus', 0);
...
('PB007', 'OR001', 'budiawan', 'TC001', 'Taman Pintar', 'BNI', '2019-12-16', 'das', 'lunas', 1);
...
('PG001', 'Penginapan A', 'Penginapan Murah dan Nyaman', 100000, 1),
('PG002', 'Penginapan B', 'Nyaman dan Aman', 150000, 0),
('PG003', 'Penginapan C', 'Mewah ', 360000, 1);
...
('TC001', 'Taman Pintar Yogyakarta', 'Taman Pintar Yogyakarta adalah wahana wisata yang terdapat di pusat Kota Yogyakarta, tepatnya di Jalan Panembahan Senopati No. 1-3, Yogyakarta, di kawasan Benteng Vredeburg. Taman ini memadukan tempat wisata rekreasi maupun edukasi dalam satu lokasi.', 12000, 'tamanpintar.jpg'),
...
INSERT INTO `tb_user` (`username`, `nama`, `password`, `email`, `alamat`, `poin`, `role`, `baned`, `logintime`, `foto`) VALUES
...
('iqbal', 'iqbal r', 'dsa', 'iqbalrpambudi@gmail.com', '', 0, 'admin', 'N', 0, 'IMG_0487.JPG');
